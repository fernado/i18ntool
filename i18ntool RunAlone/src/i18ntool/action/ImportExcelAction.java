...
public class ImportExcelAction extends Action implements IWorkbenchAction {

	public static final String ID = ImportExcelAction.class.getName();
	...
	public ImportExcelAction(final IWorkbenchWindow window) {
		this.window = window;
		setId(ID);
		setText("&" + "Import Excel Test");
		setToolTipText("Import Excel Test");
	}
